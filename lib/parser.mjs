...
import { substituteEnv } from "./envsubst.mjs";
...
export function parseSqlFile(filePath, projectRoot, env = {}) {
  const content = substituteEnv(expandIncludes(filePath, projectRoot), env);
